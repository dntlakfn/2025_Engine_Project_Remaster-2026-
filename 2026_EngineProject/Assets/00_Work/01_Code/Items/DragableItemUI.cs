...
{
    public class DragableItemUI : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
    {
        ...
        public virtual void Initialize(ItemDataSO itemData)
        {
            _itemData = itemData;
        ...
        public virtual void OnPointerClick(PointerEventData eventData)
        {
            ...
            {
                Bus<ShowItemUsePanel>.Raise(new ShowItemUsePanel(this));
            }
        }
        ...
        public struct ItemDraggingEvent : IEvent
        {
            ...
            public ItemDraggingEvent(GameObject pointerEnter, DragableItemUI item, Vector2 position)
            {
